...
public class BookingController {
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getMyBookingsByState(
        ...
        log.info("Get my bookings with state {}, userId={}", stateParam, userId);

        return bookingClient.getMyBookingsByState(userId, state);
    }
